      ...
      <div className="">
        <div className="flex justify-evenly max-md:hidden gap-2">
          <div className="flex flex-col items-center">
            ...
            <p className=" leading-3 text-center text-[0.7rem]  font-semibold" >profile</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className=" leading-3 text-center text-[0.7rem] font-semibold" >wishlist</p>
          </div>
          <div className="flex flex-col items-center">
            <svg
              viewBox="0 0 24 24"
            ...
            <p className=" leading-3 text-center text-[0.7rem] font-semibold" >cart</p>
